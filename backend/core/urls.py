...
from .views import registro, login, VerifyTokenView, lista_zonas, lista_thermostatos, lista_mediciones, detalle_zona, historico_thermostato, simular_temperatura, sensores_por_zona
...
urlpatterns = [
    ...
    path("api/detalle_zona/<id>", detalle_zona, name="detalle_zona"),
